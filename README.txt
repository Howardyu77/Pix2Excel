...
7. At the formula bar, type the name you given to the function, and it will show up. After selecting the function, hit crtl+shift+A, then the variable names will show up,too.
